    ...
    <div class="white-box todo">
      ...
      <div class="row">
        <v-container id="scroll-target" style="max-height: 525px" class="scroll-y">
          <v-layout data-app column style="height: 900px">
            ...
            <div class="text-xs-center">
              <v-dialog v-model="dialog" width="500">
                <v-card>
                  <v-card-title class="headline grey lighten-2" primary-title>Change Date</v-card-title>
                  <v-card-text>
                    <v-sheet height="300">
                      <v-calendar
                        ref="calendar"
...
export default {
  ...
  computed: {
    ...mapState({
      ctasklist: state =>
        state.leads.alltask.filter(task => {

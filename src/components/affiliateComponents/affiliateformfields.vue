  ...
  <div>
    ...
    <form>
      <div class="white-box form-body form-material">
        <div class="row float-right"v-if =" user.user.role === 'sales'" >
          <toggle-button
            :value="false"
            color="green"
            :sync="true"
            :width="120"
            :labels="{checked: 'Approved!', unchecked: 'Click to Approve'}"
          />
        </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <select
                  ...
                  data-placeholder="Therapist Type"
                  tabindex="1"
                  v-model="ttype"
                >
  ...
  computed: {
    ...
    lastname: {
      get: function() {
        console.log("LAST");
        console.log(this);
        if (this.user[0]) return this.user[0].lastname;
    ...
    phone: {
      get: function() {
        console.log("FIRDT");
        console.log(this.user);
        if (this.user[0]) return this.user[0].phone;
    ...
    email: {
      get: function() {
        console.log("LAST");
        console.log(this);
        if (this.user[0]) return this.user[0].email;
